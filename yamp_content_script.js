// ждем запрос, параметры функции обработки события chrome.extension.onRequest: это запрос, отправитель запроса, 
// (идентификаторы вкладки и дополнения) и функция отправки ответа.
if (window == top) {
